...
export const JDProfileSchema = z.object({
  roleTitle: z.string().default("Untitled role"),
  company: z.string().nullable().default(null),
  seniority: z.enum(SENIORITY).catch("mid"),
  function: z.string().default(""),
  mustHaves: z.array(RequirementSchema).default([]),
  niceToHaves: z.array(RequirementSchema).default([]),
  hardFilters: z
    .object({
      minYears: z.coerce.number().nullable().default(null),
      degree: z.string().nullable().default(null),
      location: z.string().nullable().default(null),
      certifications: z.array(z.string()).default([]),
    })
    .default({ minYears: null, degree: null, location: null, certifications: [] }),
  atsKeywords: z.array(AtsKeywordSchema).default([]),
  responsibilities: z.array(z.string()).default([]),
  tone: z.enum(TONE).catch("corporate"),
  impliedPriorities: z.array(z.string()).default([]),
});
